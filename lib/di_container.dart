...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => ChatBotRepo(dioClient: sl()));
  sl.registerLazySingleton(() => ChatBotActionExecutor(
        categoryRepo: sl(),
        productRepo: sl(),
        searchRepo: sl(),
        couponRepo: sl(),
  ...
  sl.registerLazySingleton(() => TrackerProvider(timeRepo: sl()));
  ...
  sl.registerLazySingleton(
      () => ChatBotProvider(chatBotRepo: sl(), actionExecutor: sl()));
