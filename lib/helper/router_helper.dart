...
class RouterHelper {
  ...
  static String getNotificationRoute(
          {bool fromSplash = false, RouteAction? action}) =>
      _navigateRoute('$notificationScreen?from_splash=$fromSplash',
          route: action);
  ...
  static String getCheckoutRoute(double? amount, String page, String? code,
      bool isCutlery, String deliveryType) {
    String amount0 = base64Url.encode(utf8.encode(amount.toString()));
    String deliveryTpe = base64Url.encode(utf8.encode(deliveryType));
    return _navigateRoute(
        '$checkoutScreen?amount=$amount0&delivery_type=$deliveryTpe&page=$page&&code=$code${isCutlery ? '&cutlery=1' : ''}');
  }
  ...
  static String getOrderDetailsRoute(String? id,
          ...
          RouteAction? action}) =>
      _navigateRoute(
          '$orderDetailsScreen?id=$id&phone=${Uri.encodeComponent('$phoneNumber')}&from_splash=$fromSplash',
          route: action);
  ...
  static String getTrackMapScreen({
    Order? order,
    int? orderId,
    int? deliverymanId,
  }) {
    ...
    return _navigateRoute(
        "$trackMapScreen?address=$address&deliveryman=$deliverymanId&order=$orderId");
  }

  static String getProfileRoute({RouteAction action = RouteAction.push}) =>
      _navigateRoute(profileScreen, route: action);
  ...
  static String getAddAddressRoute({
    ...
    return _navigateRoute(
        '$addAddressScreen?page=$page&action=$action&address=$data&is_current_location=$isCurrentLocation&route_type=${routeType.name}');
  }
  ...
  static String getChatRoute(
    ...
    String deliveryManData =
        base64Url.encode(utf8.encode(jsonEncode(deliveryMan?.toJson())));

    return _navigateRoute(
        '$chatScreen?order=$orderId&deliveryman=$deliveryManData&from_splash=$fromSplash',
        route: action);
  }
  ...
  static String getWalletRoute(
      ...
      _navigateRoute('$wallet?token=$token&&flag=$flag', route: action);
  ...
  static String getProductImageScreen(
  ...
  static String getOtpRegistrationScreen(String? tempToken, String userInput,
      {String? userName,
      RouteAction action = RouteAction.pushNamedAndRemoveUntil}) {
    String data = '';
    ...
    return _navigateRoute(
        '$otpRegistration?tempToken=$data&input=$input&userName=$name',
        route: action);
  }
  ...
  static String getHomeItem({required ProductType productType}) =>
      _navigateRoute('$homeItem?type=${productType.name}');
  ...
  static _isMaintenance(ConfigModel configModel) {
    if (configModel.maintenanceMode?.maintenanceStatus == 1) {
      if ((ResponsiveHelper.isWeb() &&
              configModel.maintenanceMode?.selectedMaintenanceSystem?.webApp ==
                  1) ||
    ...
    routes: [
      ...
      GoRoute(
          ...
          builder: (context, state) => _routeHandler(
              context, path: _getPath(state), const MaintenanceScreen())),
      GoRoute(
          path: languageScreen,
      ...
      GoRoute(
          path: welcomeScreen,
          builder: (context, state) => _routeHandler(
              context, path: _getPath(state), const WelcomeScreen())),
      GoRoute(
          path: loginScreen,
          builder: (context, state) => _routeHandler(
      ...
      GoRoute(
          path: searchScreen,
          builder: (context, state) => _routeHandler(
              context, path: _getPath(state), const SearchScreen())),
      GoRoute(
      ...
      GoRoute(
          path: update,
          builder: (context, state) => _routeHandler(
              context, path: _getPath(state), const ForceUpdateScreen())),
      GoRoute(
          path: setMenuScreen,
          builder: (context, state) => _routeHandler(
              context,
      ...
      GoRoute(
          ...
          builder: (context, state) {
            ...
            return _routeHandler(
                context,
                path: '${state.fullPath}?${state.uri.query}',
                CategoryScreen(
      ...
      GoRoute(
        ...
        builder: (context, state) => _routeHandler(
            ...
            NotificationScreen(
                fromSplash:
                    state.uri.queryParameters['from_splash'] == 'true')),
      ),
      ...
      GoRoute(
          ...
          builder: (context, state) {
            ...
            bool isCutlery = state.uri.queryParameters.containsKey('cutlery') &&
                (state.uri.queryParameters['cutlery']?.contains('1') ?? false);
            ...
            return _routeHandler(
                ...
                (!fromCart
                    ...
                    : CheckoutScreen(
                        ...
                        isCutlery: isCutlery,
                        isFreeDelivery: utf8.decode(base64Url.decode(
                                '${state.uri.queryParameters['delivery_type']}')) ==
                            'free_delivery',
                      )),
                isBranchCheck: true);
          }),
      ...
      GoRoute(
          ...
          builder: (context, state) {
            ...
            return _routeHandler(
                ...
                TrackMapScreen(
                  order: data,
                  deliverymanId: int.tryParse(
                      state.uri.queryParameters['deliveryman'].toString()),
                  orderId: int.tryParse(
                      state.uri.queryParameters['order'].toString()),
                ));
          }),
      GoRoute(
          path: profileScreen,
          builder: (context, state) => _routeHandler(
              context, path: _getPath(state), const ProfileScreen())),
      GoRoute(
          path: addressScreen,
          builder: (context, state) => _routeHandler(
              context, path: _getPath(state), const AddressScreen())),
      GoRoute(
          path: mapScreen,
          builder: (context, state) {
            List<int> decode = base64Decode(
            ...
            return _routeHandler(
                context, path: _getPath(state), MapWidget(address: data));
          }),
      GoRoute(
          ...
          builder: (context, state) {
            ...
            final RouteTypeEnum routeType = RouteTypeEnumExtension.fromString(
                state.uri.queryParameters['route_type'] ?? '');
            ...
            return _routeHandler(
              ...
              AddNewAddressScreen(
                ...
                isCurrentLocation: state
                        .uri.queryParameters['is_current_location']
                        ?.contains('true') ??
                    false,
                routeType: routeType,
              ),
      ...
      GoRoute(
          ...
          builder: (context, state) {
            DeliveryMan? deliveryMan;
            try {
              deliveryMan = DeliveryMan.fromJson(jsonDecode(utf8.decode(
                  base64Url.decode(
                      '${state.uri.queryParameters['deliveryman']?.replaceAll(' ', '+')}'))));
            } catch (error) {
            ...
            return _routeHandler(
                ...
                ChatScreen(
                  orderId:
                      int.tryParse('${state.uri.queryParameters['order']}'),
                  fromSplash:
                      state.uri.queryParameters['from_splash'] == 'true',
      ...
      GoRoute(
          path: couponScreen,
          builder: (context, state) => _routeHandler(
              context, path: _getPath(state), const CouponScreen())),
      GoRoute(
          path: supportScreen,
      ...
      GoRoute(
          path: referAndEarn,
          builder: (context, state) => _routeHandler(
              context, path: _getPath(state), const ReferAndEarnScreen())),
      GoRoute(
          path: branchListScreen,
          builder: (context, state) => _routeHandler(
              context, path: _getPath(state), const BranchListScreen())),
      GoRoute(
      ...
      GoRoute(
          path: loyaltyScreen,
          builder: (context, state) => _routeHandler(
              context, path: _getPath(state), const LoyaltyScreen())),
      GoRoute(
          path: orderSearchScreen,
          builder: (context, state) => _routeHandler(
              context, path: _getPath(state), const OrderSearchScreen())),
      ...
      GoRoute(
          path: branchScreen,
          builder: (context, state) => _routeHandler(
              context, path: _getPath(state), const BranchScreen())),
      GoRoute(
          path: homeItem,
          builder: (context, state) {
            return _routeHandler(
          ...
          builder: (context, state) {
            return _routeHandler(
                ...
                OtpRegistrationScreen(
                  tempToken:
                      jsonDecode(state.uri.queryParameters['tempToken'] ?? ''),
                  userInput:
                      jsonDecode(state.uri.queryParameters['input'] ?? ''),
                  userName:
                      jsonDecode(state.uri.queryParameters['userName'] ?? ''),
                ));
          }),
    ],
  );
